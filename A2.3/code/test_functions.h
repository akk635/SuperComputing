...
int test_communication( char *file_in, char *file_vtk_out, int *local_global_index, int nintci,
                        int nintcf, int points_count, int **points, int *elems,
                        int local_int_cells, int *send_count, int **send_list, int *recv_count,
                        int **recv_list , int writing_proc );
